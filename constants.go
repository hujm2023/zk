...
var (
	...
	ErrSessionClosedRequiresSASLAuth = errors.New("zk: session closed because server requires SASL authentication")
	...
	errCodeToError = map[ErrCode]error{
		...
		errSessionClosedRequiresSASLAuth: ErrSessionClosedRequiresSASLAuth,
...
const (
	...
	errSessionClosedRequiresSASLAuth ErrCode = -124
)
